...
class AdminService
{
     ...
     */
    public function __construct(AdminContract $adminRepository,UserContract $userRepository, AdsContract $adsRepository, ProfileContract $profileRepository, PaymentContract $paymentRepository,PackageContract $packageRepository,AdPackagesContract $adPackagesRepository)
    {
    ...
    public function fetchPaymentDetails($id){
        $payment = $this->paymentRepository->getPaymentDetails($id);
        return $this->adPackagesRepository->getPaymentAdPackageDetails($payment);
    }
}