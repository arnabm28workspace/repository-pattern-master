    ...
    <div class="row">
        <div class="col-12 col-xl-7">
                       ...
                       <div class="col-12">
                        ...
                        @foreach($data['ad']->images as $image)
                            <div class="col-12 px-1">
                                ...
                                @if($image->image=='http://placehold.jp/350x350.png')
            ...
            <div class="card table-card">
                <table class="table table-card-full table-hover custom-data-table-style table-striped table-col-width" id="sampleTable">
                    <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ $detail->key == 'price'? App\Models\Setting::get('currency_symbol').ucwords($detail->value):ucwords($detail->value) }}</td> 
                            </tr>
                            ...
                            <tr>
                                ...
                                <table class="table inner-table">
                                        ...
                                        <tr>
                                            <td>{{ $v }}</td>
                                            <td>{{(isset($rates[0]->val[$key]) && $rates[0]->val[$key]!='')?'£'.$rates[0]->val[$key]:'-'}}</td>
                                            <td>{{(isset($rates[1]->val[$key]) && $rates[1]->val[$key]!='')?'£'.$rates[1]->val[$key]:'-'}}</td>
                                        </tr>
                                        @endforeach
                                        </tbody>
                                    </table> 
