<!-- Modal -->
<div class="modal fade" id="upgradePaymentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<form style="margin-bottom:20px;" accept-charset="UTF-8" action="{{route('upgradepayment')}}" class="require-validation"
...
<script src='https://js.stripe.com/v2/' type='text/javascript'></script>
<script type="text/javascript" src="{{ asset('frontend/js/upgradepayment.js') }}"></script>
