                ...
                <form action="{{ route('admin.blogs.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="name">Blog Category <span class="m-l-5 text-danger"> *</span></label>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" id="status" name="status"/>Publish
                                </label>
                            </div>
                        </div>
                    </div>
